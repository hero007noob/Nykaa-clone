...
var priority=JSON.parse(localStorage.getItem("bag-list")) || []
    function addtobag(task,index)
    {
    priority.push(task);
    localStorage.setItem("bag-list",JSON.stringify(priority));
    addedtasks.splice(index,1);
    localStorage.setItem("cart-list",JSON.stringify(addedtasks))
    displaytasks(addedtasks)
    ...
    function buy(task)
    {
      ...
      // paste the payment page link in this
