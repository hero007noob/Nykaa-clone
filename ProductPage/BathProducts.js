...
var pagefaceData=faceData.slice(reqnofrom,reqnoto);
  ...
  function display(list){
    list.map(function(elem,index){
        ...
        keyword.setAttribute("class","font-product-bestseller");
        ...
        var prcbox =document.createElement("div");
        var prc =document.createElement("h4");
        prc.textContent="MRP: "+elem.price;
        prc.setAttribute("class","font-product-item-MRP");
        var mrp =document.createElement("h4");
        if (elem.discount_price==undefined)
        {
          prcbox.append(prc);
        }
        else{
          mrp.textContent=elem.discount_price+"  ";
        ...
        prcbox.setAttribute("class","Bathchild2prcbox");
  ...
  {//Bath items list -- child 1
  const selectbtn = document.querySelector(".Bc1-select-btn");
  const items = document.querySelectorAll(".Bc1-list-items1");
  ...
  const selectbtn2 = document.querySelector(".Bc1-select-btn2");
  const items2 = document.querySelectorAll(".Bc1-list-items2");
  // console.log(selectbtn,items);
  ...
  const selectbtn3 = document.querySelector(".Bc1-select-btn3");
  const items3 = document.querySelectorAll(".Bc1-list-items3");
  // console.log(selectbtn,items);
  ...
  const selectbtn4 = document.querySelector(".Bc1-select-btn4");
  const items4 = document.querySelectorAll(".Bc1-list-items4");
  // console.log(selectbtn,items);
  ...
  const selectbtn5 = document.querySelector(".Bc1-select-btn5");
  const items5 = document.querySelectorAll(".Bc1-list-items5");
  // console.log(selectbtn,items);
  ...
  const selectbtn6 = document.querySelector(".Bc1-select-btn6");
  const items6 = document.querySelectorAll(".Bc1-list-items6");
  // console.log(selectbtn,items);
  ...
  const selectbtn7 = document.querySelector(".Bc1-select-btn7");
  const items7 = document.querySelectorAll(".Bc1-list-items7");
  // console.log(selectbtn,items);
  ...
  const selectbtn8 = document.querySelector(".Bc1-select-btn8");
  const items8 = document.querySelectorAll(".Bc1-list-items8");
  // console.log(selectbtn,items);
  selectbtn8.addEventListener("click",() => {
    selectbtn8.classList.toggle("open");
  });
  items8.forEach(item=> {
    item.addEventListener("click",() =>
    {
  ...
  const selectbtn10 = document.querySelector(".Bc1-select-btn10");
  const items10 = document.querySelectorAll(".Bc1-list-items10");
  // console.log(selectbtn,items);
  selectbtn10.addEventListener("click",() => {
    selectbtn10.classList.toggle("open");
  });
  ...
  const selectbtn9 = document.querySelector(".Bc1-select-btn9");
  const items9 = document.querySelectorAll(".Bc1-list-items9");
  // console.log(selectbtn,items);
  selectbtn9.addEventListener("click",() => {
    selectbtn9.classList.toggle("open");
  });
  items9.forEach(item=> {
    item.addEventListener("click",() =>
    {
